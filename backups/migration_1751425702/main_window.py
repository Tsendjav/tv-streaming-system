...
try:
    ...
    print("⚠️ Using legacy streaming tab")
    print("⚠️ Using legacy streaming tab")
    tabs_available['streaming'] = StreamingTab
    print("✅ Streaming tab imported")
except ImportError as e:
    print(f"❌ Streaming tab import failed: {e}")
    tabs_available['streaming'] = None
    ...
    def _create_tabs(self):
        ...
        if tabs_available['playout']:
            try:
                ...
                if hasattr(media_tab, 'media_selected'):
                ...
                if hasattr(playout_tab, 'set_media_library_tab'):
